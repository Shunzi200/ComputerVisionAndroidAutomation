...
def testScript(serialname, delay):
    ...
    while val < 1:
        ...
        temp = os.path.join(imagepath, 'temp.png')
        temp2 = os.path.join(imagepath, 'temp3.png')
        temp3 = os.path.join(imagepath, 'temp2.png')
        ...
        if buttonclick1 == 0:
            if button1match == 1:
                time.sleep(delay)
                print("")
                print("[" + serialname + "] Clicking Notify Me...")
                m1 = '"' + str(s1) + '"'
                n1 = '"' + str(p1) + '"'
                os.chdir(toolspath)
        ...
        if buttonclick2 == 0:
            if button2match == 1 and matched == 1:
                time.sleep(delay)
                print("")
                print("[" + serialname + "] Liking Product...")
                m2 = '"' + str(s2) + '"'
                n2 = '"' + str(p2) + '"'
                os.chdir(toolspath)
        ...
        if button3match == 1 and matched2 == 1:
            time.sleep(delay)
            print("")
            print("[" + serialname + "] Exiting Product...")
            m3 = '"' + str(s3) + '"'
            n3 = '"' + str(p3) + '"'
            os.chdir(toolspath)
